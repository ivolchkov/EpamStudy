package ua.epam.task5.student.view.domainFront;
...
public class StudentFront {
    ...
    private StudentFront(StudentBuilder studentBuilder) {
    ...
    public boolean equals(Object obj) {
        ...
        StudentFront other = (StudentFront) obj;
    ...
    public static class StudentBuilder {
        ...
        public StudentFront build() {
            return new StudentFront(this);
        }
    }
    
    private static class BuilderSetId {
        ...
        private static void setId(StudentFront student) {
            student.id = ++counter;
        }
    }
